...
/**
 * Content	: Resuable Delete Button
 * Date	 	:
 * Feature	:
 */
function deleteButton($deleteID, $buttonName, $isFileExist = null, $action = "delete")
{
	...
	$makeForm .= '<button name="' . $buttonName . '" class="btn btn-primary btn-sm waves-effect waves-light mw-80" type="submit"><i class="fas fa-trash"></i> Trash</button>';
	$makeForm .= '</form>';
